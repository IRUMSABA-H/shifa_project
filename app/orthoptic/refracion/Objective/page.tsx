  ...
  return (
    <>
      ...
      >
                    ...
                    {fields.map(({ key, name }) => (
                      ...
                      >
                        ...
                        <Col span={8.5}>
                          ...
                          >
                            <Radio.Group
                              className={styles.refractionRadioGroup}
                            >
                ...
                <Col span={9}>
                  <Form.Item noStyle name="right_eye_reflex">
                    <Radio.Group className="flex gap-1">
                      ...
                      <Radio value="Dull reflex" className="text-[10px]">
                        Dull Reflex
                      </Radio>
                ...
                <Col span={5}>
                  <Form.Item noStyle name="right_others_value">
                    <Input
                      ...
                      size="small"
                      disabled={formValues?.right_eye_reflex !== "others"}
                    />
                  </Form.Item>
                </Col>
                ...
                <Col span={5}>
                  <Form.Item noStyle name="left_others_value">
                    <Input
                      placeholder="Others Value"
                      size="small"
                      disabled={formValues?.left_eye_reflex !== "others"}
                    />
                  </Form.Item>
                </Col>
                <Col span={3} className="text-right font-bold text-[10px]">
              ...
              <div className="text-center">
                ...
                <div className="relative w-20 h-20 border-black">
                  ...
                  {["R1", "R2", "R3", "R4"].map((pos) => (
                    <div
                      key={pos}
                      className={`absolute text-[9px] w-1/2 h-1/2 flex items-center justify-center p-2  overflow-hidden break-words
                        ${pos === "R1" ? "top-0 left-0" : pos === "R2" ? "top-0 left-1/2" : pos === "R3" ? "top-1/2 left-0" : "top-1/2 left-1/2"}`}
                    >
                      <span
                        className={
                          rightEye.placement === pos
                            ? "text-blue-600 font-bold"
                            : "text-gray-300"
                        }
                      >
                        {rightEye.placement === pos
                          ? rightEye.displayText
                          : pos}
                      </span>
                    </div>
                  ))}
        ...
        <div className="flex flex-row justify-center gap-3 ml-100">
          <div className="ml-50">
